    ...
    <View style={styles.container}>
      ...
      <View style={styles.controls}>
        ...
        <Text style={styles.weekLabel}>
          {format(new Date(weekStart + 'T00:00:00Z'), 'MMM d')} -{' '}
          {format(addDays(new Date(weekStart + 'T00:00:00Z'), 6), 'MMM d')}
        </Text>
      ...
      <ScrollView contentContainerStyle={styles.weekContainer}>
        ...
        <View style={styles.tipsContainer}>
          ...
          <List.Section>
            ...
            <List.Item title="2. Prioritize compound lifts" description="Place high-skill/compound exercises early in the week." />
            <List.Item title="3. Plan rest intentionally" description="At least one rest or active recovery day per week." />
            <List.Item title="4. Avoid overtraining" description="If you're sore or sleep-deprived, adjust the plan." />
            <List.Item title="5. Track & adapt" description="Use your completed workouts to plan next week smartly." />
          </List.Section>
        </View>
      </ScrollView>
            ...
            renderItem={({ item }) => {
              ...
              return (
                <List.Item
                  ...
                  right={() => (
                    <Button mode="contained" disabled={!unlocked} onPress={() => handleAddToDate(selectedDate, item.id)}>
                      Add
                    </Button>
                  )}
                />
